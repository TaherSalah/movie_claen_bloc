...
import 'package:movie_db_bloc/movies/presentation/controller/movies_events.dart';
import 'package:movie_db_bloc/movies/presentation/controller/movies_states.dart';
    ...
    return BlocProvider(
      ...
      child: BlocBuilder<MovieBloc,MoviesStates>(
        builder: (context, state) {
          print(state.getNowPlayingMoviesState);
